...
<svelte:head>
  <title>Terms & Conditions &bullet; Caruxell</title>
  <meta
    name="description"
    content="The Terms and Conditions page of Caruxell. Check out what you are allowed and what you are not allowed to do with our software."
  />
  ...
  <link
    rel="alternate"
    href="https://www.caruxell.com/en/terms-and-conditions"
    hreflang="en"
  />
  <link
    rel="alternate"
    href="https://www.caruxell.com/ro/terms-and-conditions"
    hreflang="ro"
  />
...
<div class="wrapper">
  ...
  <p>Welcome to CARUXELL!</p>

  <p>
    These terms and conditions outline the rules and regulations for the use of
    CARUXELL SOFTWARE SRL's Website, located at https://caruxell.com.
  </p>

  <p>
    By accessing this website we assume you accept these terms and conditions.
    Do not continue to use CARUXELL if you do not agree to take all of the terms
  ...
  <p>
    We employ the use of cookies. By accessing CARUXELL, you agreed to use
    cookies in agreement with the CARUXELL SOFTWARE SRL's Privacy Policy.
  </p>
  ...
  <p>
    Unless otherwise stated, CARUXELL SOFTWARE SRL and/or its licensors own the
    intellectual property rights for all material on CARUXELL. All intellectual
    property rights are reserved. You may access this from CARUXELL for your own
    personal use subjected to restrictions set in these terms and conditions.
  </p>

  <p>You must not:</p>
  <ul>
    <li>Republish material from CARUXELL</li>
    <li>Sell, rent or sub-license material from CARUXELL</li>
    <li>Reproduce, duplicate or copy material from CARUXELL</li>
    <li>Redistribute content from CARUXELL</li>
  </ul>

  <p>
    Parts of this website offer an opportunity for users to post and exchange
    opinions and information in certain areas of the website. CARUXELL SOFTWARE
    SRL does not filter, edit, publish or review Comments prior to their
    presence on the website. Comments do not reflect the views and opinions of
    CARUXELL SOFTWARE SRL,its agents and/or affiliates. Comments reflect the
    views and opinions of the person who post their views and opinions. To the
    extent permitted by applicable laws, CARUXELL SOFTWARE SRL shall not be
  ...
  <p>
    CARUXELL SOFTWARE SRL reserves the right to monitor all Comments and to
  ...
  <p>
    You hereby grant CARUXELL SOFTWARE SRL a non-exclusive license to use,
  ...
  <p>
    ...
    compensates the absence of CARUXELL SOFTWARE SRL; and (d) the link is in the
  ...
  <p>
    ...
    e-mail to CARUXELL SOFTWARE SRL. Please include your name, your organization
    name, contact information as well as the URL of your site, a list of any
    URLs from which you intend to link to our Website, and a list of the URLs on
  ...
  <p>
    No use of CARUXELL SOFTWARE SRL's logo or other artwork will be allowed for
